...
loss = nn.NLLLoss(reduction='elementwise_mean')
# KL-Div Loss
...
for epoch in range(0,args.epochs):
    ...
    if f1>best_f1:
        ...
        torch.save(model.state_dict(),'Network_with_Focal_loss_Clustering_loss.model.'+GPUINX)
    else:
        patience-=1
        if patience==0:
            break
